  ...
  useEffect(() => {
    const fetchLiveAnalytics = async () => {
      try {
        ...
        // فلترة صارمة لإحضار الأسهم التي تقل أسعارها عن 100 دولار فقط
        const allStocks = [
    ...
    <div style={{ minHeight: '100vh', backgroundColor: '#07090E', color: '#F8FAFC', fontFamily: 'sans-serif', direction: 'rtl', padding: '30px' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px', backgroundColor: '#0B0F17', padding: '16px 24px', borderRadius: '16px', border: '1px solid #1F2636' }}>
        <div>
          ...
          <p style={{ color: '#94A3B8', fontSize: '11px' }}>مسح متقدم لكواتم أوامر فايناس واختراقات القمم التاريخية (الأسهم أقل من 100$).</p>
        </div>
      ...
      {/* أزرار التبويب (تم تفعيلها بالكامل هنا) */}
      ...
      {/* محتوى الشاشة بناءً على التبويب النشط */}
      {activeTab === 'backtest' ? (
