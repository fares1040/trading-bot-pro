  ...
  return (
    <div style={{ backgroundColor: '#121212', color: '#fff', minHeight: '100vh', padding: '20px', fontFamily: 'monospace' }}>
      ...
      <div style={{ padding: '20px', border: '1px solid #333' }}>
        <input onChange={(e) => setTicker(e.target.value)} placeholder="رمز السهم..." style={{ width: '100%', padding: '10px', color: '#000' }} />
        <button onClick={checkStock} style={{ width: '100%', marginTop: '10px', padding: '10px', backgroundColor: '#00ff41', color: '#000', fontWeight: 'bold' }}>تحليل</button>
      </div>
      {result && (
        <div style={{ padding: '15px', border: `2px solid ${result.status}`, marginTop: '10px' }}>
