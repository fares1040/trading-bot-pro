      ...
      if (item.status === 'fulfilled') {
        ...
        all.push(
          ...item.value.rows.map((row, index) => ({
            ...
            liquidityScore: item.value.ranking[index]?.optionsIntelligence?.liquidityScore ?? null,
            liquidityStrength: item.value.ranking[index]?.optionsIntelligence?.liquidityStrength ?? 'UNAVAILABLE',
            riskLevel: item.value.ranking[index]?.optionsIntelligence?.riskLevel ?? 'UNAVAILABLE',
            optionsScore: item.value.ranking[index]?.optionsIntelligence?.optionsScore ?? null,
