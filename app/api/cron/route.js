...
export async function GET(request) {
  try {
    ...
    // [تم التعديل]: تفعيل إيقاف التنفيذ تلقائياً عندما يكون السوق مغلقاً لتوفير الموارد
    if (!isMarketTimeActive) {
      return NextResponse.json({ success: true, message: 'السوق مغلق حالياً بتوقيت السعودية. تم تخطي الفحص.', market_active: false }, { status: 200 });
    }
