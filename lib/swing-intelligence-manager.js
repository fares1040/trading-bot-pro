...
function normalizeSwingIntelligence(marketData, opts = {}) {
  ...
  return {
    ...
    expectedTimeframe: quality === 'TOP' || quality === 'STRONG' ? '1–3 Months' : quality === 'WATCH' ? '1–2 Weeks' : 'UNKNOWN',
...
function classifySwingRisk(score, riskLevel) {
  ...
  if (typeof riskLevel === 'string' && Object.prototype.hasOwnProperty.call(VALID_RISK_LEVELS, riskLevel.toUpperCase())) {
