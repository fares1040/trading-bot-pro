...
class TrackRecordService {
  constructor() {
    // Use localStorage in the browser (consistent with existing analytics pattern).
    // Server-side consumers use an empty in-memory record set because localStorage is unavailable.
  ...
  // Load track record from localStorage when running in the browser
  load() {
  ...
  // Save track record to localStorage when running in the browser
  save() {
